...
class SchedulingConstraintRegistry:
    ...
    def _organize_constraints(self):
        ...
        for constraint in self.constraints:
            ...
            if not constraint.constraintCategory:
                ...
                print(f"Warning: Skipping constraint {constraint.constraintId} - unknown type: {constraint.constraintType}")
                continue
    ...
    def get_teacher_constraints_by_category(self, teacher_id: str, category: SchedulingConstraintCategory) -> List[Constraint]:
    ...
    def get_constraints_by_category(self, category: SchedulingConstraintCategory) -> List[Constraint]:
