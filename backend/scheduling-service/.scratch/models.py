...
class Course(BaseModel):
    ...
    # The list is a list of student groups for each session type. Each list item in the list is a list of student group ids that take the course together (at the same time and place).
